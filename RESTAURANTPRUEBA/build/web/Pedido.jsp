    ...
    <body>
        ...
        <form action="ingresar.jsp" method="post" id="form">
            ...
            <h2 id="etiquetas">Codigo de pedido:
                <input type="text" name="codigo" autocomplete="off"></h2> 
            ...
            <h2 id="etiquetas">Cantidad:
                <input type="text" name="cantidad" autocomplete="off" ></h2> 
            <br></br>
            <h1 id="titulo">Cliente</h1>
            <br></br>
            <h2 id="etiquetas">Nombre:
                <input id="etiquetasizquierda" type="text" name="nombre" ></h2> 
            <h2 id="etiquetas">RUC / C.I. : 
                <input type="text" name="cd" ></h2>
            <br>
